...
* **Sanitizer API:** Нативный стандарт безопасности для декларативной очистки HTML-строк в памяти браузера, минимизирующий риски межсайтового скриптинга (XSS) при инъекциях динамического контента.
